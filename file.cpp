...
uint8_t File::LoadGrafix(const unsigned char * file){   
...
void File::OpenFile(uint8_t channel, const unsigned char *  fileName, uint8_t mode)
{
...
uint8_t File::LoadFile( int memory, const unsigned char * fileName)
{
	int ptr = (int) &fileName[0];
  	*API_FUNCTION_ADDR     = API_FN_LOAD_FILE;
...
uint8_t File::SaveFile( int memory, int nrbyte , const unsigned char * fileName)
{
	int ptr = (int) &fileName[0];
